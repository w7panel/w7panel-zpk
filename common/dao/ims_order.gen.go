...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.ParentID = field.NewInt32(tableName, "parent_id")
	_order.OrderSn = field.NewString(tableName, "order_sn")
	_order.UserID = field.NewInt32(tableName, "user_id")
	_order.RemoteBuyerUID = field.NewInt32(tableName, "remote_buyer_uid")
	_order.OrderType = field.NewInt32(tableName, "order_type")
	_order.TotalFee = field.NewFloat64(tableName, "total_fee")
	_order.BuyShop = field.NewString(tableName, "buy_shop")
	_order.FormulaID = field.NewInt32(tableName, "formula_id")
	_order.FormulaVersion = field.NewString(tableName, "formula_version")
	_order.ProductType = field.NewInt32(tableName, "product_type")
	_order.OutOrderSn = field.NewString(tableName, "out_order_sn")
	_order.UsedTime = field.NewTime(tableName, "used_time")
	_order.ServiceExpireTime = field.NewInt32(tableName, "service_expire_time")
	_order.ServiceExpireTimeV2 = field.NewTime(tableName, "service_expire_time_v2")
...
type order struct {
	...
	UserID              field.Int32
	RemoteBuyerUID      field.Int32
	OrderType           field.Int32
	TotalFee            field.Float64
	BuyShop             field.String
	FormulaID           field.Int32
	FormulaVersion      field.String
	ProductType         field.Int32
	OutOrderSn          field.String
	UsedTime            field.Time
	ServiceExpireTime   field.Int32
	ServiceExpireTimeV2 field.Time
	PayStatus           field.Int32
	PaidAt              field.Time
...
func (o *order) updateTableName(table string) *order {
	...
	o.RemoteBuyerUID = field.NewInt32(table, "remote_buyer_uid")
	o.OrderType = field.NewInt32(table, "order_type")
	o.TotalFee = field.NewFloat64(table, "total_fee")
	o.BuyShop = field.NewString(table, "buy_shop")
	o.FormulaID = field.NewInt32(table, "formula_id")
	o.FormulaVersion = field.NewString(table, "formula_version")
	o.ProductType = field.NewInt32(table, "product_type")
	o.OutOrderSn = field.NewString(table, "out_order_sn")
	o.UsedTime = field.NewTime(table, "used_time")
	o.ServiceExpireTime = field.NewInt32(table, "service_expire_time")
	o.ServiceExpireTimeV2 = field.NewTime(table, "service_expire_time_v2")
...
func (o *order) fillFieldMap() {
	...
	o.fieldMap["remote_buyer_uid"] = o.RemoteBuyerUID
	o.fieldMap["order_type"] = o.OrderType
	o.fieldMap["total_fee"] = o.TotalFee
	o.fieldMap["buy_shop"] = o.BuyShop
	o.fieldMap["formula_id"] = o.FormulaID
	o.fieldMap["formula_version"] = o.FormulaVersion
	o.fieldMap["product_type"] = o.ProductType
	o.fieldMap["out_order_sn"] = o.OutOrderSn
	o.fieldMap["used_time"] = o.UsedTime
	o.fieldMap["service_expire_time"] = o.ServiceExpireTime
	o.fieldMap["service_expire_time_v2"] = o.ServiceExpireTimeV2
