...
func newTag(db *gorm.DB, opts ...gen.DOOption) tag {
	...
	_tag.TagFormula = tagHasManyTagFormula{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("TagFormula", "entity.TagFormula"),
		Formula: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("TagFormula.Formula", "entity.Formula"),
		},
		Tag: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("TagFormula.Tag", "entity.Tag"),
		},
	}
...
type tag struct {
	...
	ID         field.Int32
	Name       field.String
	TagFormula tagHasManyTagFormula
...
type tagHasManyTagFormula struct {
	db *gorm.DB
...
func (a tagHasManyTagFormula) Where(conds ...field.Expr) *tagHasManyTagFormula {
	if len(conds) == 0 {
		return &a
	}
...
func (a tagHasManyTagFormula) WithContext(ctx context.Context) *tagHasManyTagFormula {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a tagHasManyTagFormula) Session(session *gorm.Session) *tagHasManyTagFormula {
	a.db = a.db.Session(session)
	return &a
}

func (a tagHasManyTagFormula) Model(m *entity.Tag) *tagHasManyTagFormulaTx {
	return &tagHasManyTagFormulaTx{a.db.Model(m).Association(a.Name())}
}

type tagHasManyTagFormulaTx struct{ tx *gorm.Association }

func (a tagHasManyTagFormulaTx) Find() (result []*entity.TagFormula, err error) {
	return result, a.tx.Find(&result)
}

func (a tagHasManyTagFormulaTx) Append(values ...*entity.TagFormula) (err error) {
...
func (a tagHasManyTagFormulaTx) Replace(values ...*entity.TagFormula) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a tagHasManyTagFormulaTx) Delete(values ...*entity.TagFormula) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a tagHasManyTagFormulaTx) Clear() error {
	return a.tx.Clear()
}

func (a tagHasManyTagFormulaTx) Count() int64 {
	return a.tx.Count()
}
