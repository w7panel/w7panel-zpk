...
func newTagFormula(db *gorm.DB, opts ...gen.DOOption) tagFormula {
	...
	_tagFormula.Formula = tagFormulaHasOneFormula{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Formula", "entity.Formula"),
	}

	_tagFormula.Tag = tagFormulaHasOneTag{
		db: db.Session(&gorm.Session{}),
...
type tagFormula struct {
	...
	Formula   tagFormulaHasOneFormula

	Tag tagFormulaHasOneTag
...
type tagFormulaHasOneFormula struct {
	db *gorm.DB

	field.RelationField
}

func (a tagFormulaHasOneFormula) Where(conds ...field.Expr) *tagFormulaHasOneFormula {
	if len(conds) == 0 {
		return &a
	}
...
func (a tagFormulaHasOneFormula) WithContext(ctx context.Context) *tagFormulaHasOneFormula {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a tagFormulaHasOneFormula) Session(session *gorm.Session) *tagFormulaHasOneFormula {
	a.db = a.db.Session(session)
	return &a
}

func (a tagFormulaHasOneFormula) Model(m *entity.TagFormula) *tagFormulaHasOneFormulaTx {
	return &tagFormulaHasOneFormulaTx{a.db.Model(m).Association(a.Name())}
}

type tagFormulaHasOneFormulaTx struct{ tx *gorm.Association }

func (a tagFormulaHasOneFormulaTx) Find() (result *entity.Formula, err error) {
	return result, a.tx.Find(&result)
}

func (a tagFormulaHasOneFormulaTx) Append(values ...*entity.Formula) (err error) {
...
func (a tagFormulaHasOneFormulaTx) Replace(values ...*entity.Formula) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a tagFormulaHasOneFormulaTx) Delete(values ...*entity.Formula) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a tagFormulaHasOneFormulaTx) Clear() error {
	return a.tx.Clear()
}

func (a tagFormulaHasOneFormulaTx) Count() int64 {
	return a.tx.Count()
}

type tagFormulaHasOneTag struct {
	db *gorm.DB

	field.RelationField
}

func (a tagFormulaHasOneTag) Where(conds ...field.Expr) *tagFormulaHasOneTag {
	if len(conds) == 0 {
		return &a
	}
...
func (a tagFormulaHasOneTag) WithContext(ctx context.Context) *tagFormulaHasOneTag {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a tagFormulaHasOneTag) Session(session *gorm.Session) *tagFormulaHasOneTag {
	a.db = a.db.Session(session)
	return &a
}

func (a tagFormulaHasOneTag) Model(m *entity.TagFormula) *tagFormulaHasOneTagTx {
	return &tagFormulaHasOneTagTx{a.db.Model(m).Association(a.Name())}
}

type tagFormulaHasOneTagTx struct{ tx *gorm.Association }

func (a tagFormulaHasOneTagTx) Find() (result *entity.Tag, err error) {
	return result, a.tx.Find(&result)
}

func (a tagFormulaHasOneTagTx) Append(values ...*entity.Tag) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a tagFormulaHasOneTagTx) Replace(values ...*entity.Tag) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a tagFormulaHasOneTagTx) Delete(values ...*entity.Tag) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a tagFormulaHasOneTagTx) Clear() error {
	return a.tx.Clear()
}

func (a tagFormulaHasOneTagTx) Count() int64 {
	return a.tx.Count()
}
