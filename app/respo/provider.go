...
func (provider *Provider) Register(httpServer *http_server.Server, console console.Console) {
	...
	httpServer.RegisterRouters(func(engine *gin.Engine) {
		...
		group.Match([]string{"GET", "OPTIONS"}, "/info/:id", middleware.Auth{CanSkip: true}.Process, middleware.CloudAccessToken{}.Process, middleware.ConsoleUser{CanSkip: true}.Process, controller.Formula{}.Info)
		group.Match([]string{"GET", "OPTIONS"}, "/info/:id/:cid", middleware.Auth{CanSkip: true}.Process, middleware.CloudAccessToken{}.Process, middleware.ConsoleUser{CanSkip: true}.Process, controller.Formula{}.Info)
		group.Match([]string{"GET", "OPTIONS"}, "/v2/info/:id/:version", middleware.Auth{CanSkip: true}.Process, middleware.CloudAccessToken{}.Process, middleware.ConsoleUser{CanSkip: true}.Process, controller.Formula{}.Info)
		group.Match([]string{"GET", "OPTIONS"}, "/v2/info/:id/:version/:cid", middleware.Auth{CanSkip: true}.Process, middleware.CloudAccessToken{}.Process, middleware.ConsoleUser{CanSkip: true}.Process, controller.Formula{}.Info)
